...
function addTaskInput() {
  ...
  document.getElementById("focus").style.visibility =
    "visible";
...
function addCard() {
  ...
  headDiv.addEventListener('click', ()=>{
    ...
    backbtn.addEventListener("click",()=>{
      // addCard();
      document.getElementById("main-heading").style.visibility="visible";
      document.getElementById("middletxt").style.visibility="hidden";
      document.getElementById("backbtn").style.visibility="hidden";

    })
    document.getElementById("main-heading").style.fontSize = "80px";
    // h.innerText="";
